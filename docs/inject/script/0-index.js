...
(function (global, factory) {
  ...
  locale.registerLocaleData('supplemental/likelySubtags.json', likelySubtags);
  locale.registerLocaleData('supplemental/metaZones.json', metaZones);
  locale.registerLocaleData('supplemental/weekData.json', weekData);
