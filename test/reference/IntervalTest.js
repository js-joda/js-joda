...
describe('org.threeten.extra.TestInterval', () => {
    ...
    describe('Interval.of', () => {
        ...
        it('test_of_Instant_Instant', () => {
            let test = Interval.of(NOW1, NOW2);
        ...
        it('test_of_Instant_Instant_empty', () => {
            let test = Interval.of(NOW1, NOW1);
            assertEquals(test.start(), NOW1);
        ...
        it('test_of_Instant_Duration', () => {
            let test = Interval.of(NOW1, Duration.ofSeconds(60));
            assertEquals(test.start(), NOW1);
            assertEquals(test.end(), NOW2);
        });
        
        it('test_of_Instant_Duration_zero', () => {
            let test = Interval.of(NOW1, Duration.ZERO);
            assertEquals(test.start(), NOW1);
            assertEquals(test.end(), NOW1);
        });
    ...
    describe('withStart', () => {
        it('test_withStart', () => {
            let base = Interval.of(NOW1, NOW3);
            let test = base.withStart(NOW2);
        ...
        it('test_withStart_badOrder', () => {
            expect(() => {
                let base = Interval.of(NOW1, NOW2);
                base.withStart(NOW3);
            }).to.throw(DateTimeException);
        });
    ...
    describe('withEnd', () => {
        ...
        it('test_withEnd_badOrder', () => {
            expect(() => {
                let base = Interval.of(NOW2, NOW3);
                base.withEnd(NOW1);
            }).to.throw(DateTimeException);
        });
    ...
    describe('contains', () => {
        ...
        it('test_contains_max', () => {
            let test = Interval.of(NOW2, Instant.MAX);
    ...
    describe('intersection', () => {
        ...
        it('test_intersection', () => {
            dataProviderTest(data_intersection, (start1, end1, start2, end2, expStart, expEnd) => {
                
                let test1 = Interval.of(start1, end1);
                let test2 = Interval.of(start2, end2);
                let expected = Interval.of(expStart, expEnd);
        ...
        it('test_intersectionBad', () => {
            expect(() => {
                let test1 = Interval.of(NOW1, NOW2);
                let test2 = Interval.of(NOW3, NOW4);
        ...
        it('test_intersection_same', () => {
            let test = Interval.of(NOW2, NOW4);
    ...
    describe('equals', () => {
        it('test_equals', () => {
            let a = Interval.of(NOW1, NOW2);
            let a2 = Interval.of(NOW1, NOW2);
            let b = Interval.of(NOW1, NOW3);
            let c = Interval.of(NOW2, NOW2);
