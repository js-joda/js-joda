...
[![Sauce Browser Matrix](https://saucelabs.com/browser-matrix/js-joda.svg?branch=main&4242)](https://saucelabs.com/u/js-joda)
...
To use js-joda from a browser, download js-joda from a cdn (eg https://cdn.jsdelivr.net/npm/@js-joda/core) 
